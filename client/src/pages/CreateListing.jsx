...
function CreateListing() {
  ...
  const handleSubmit=async (e)=>{
    ...
    <main className="p-3 max-w-4xl mx-auto">
      <h1 className="text-3xl font-semibold text-center my-7">Create a Listing
      </h1>
      <form action="" className="flex flex-col sm:flex-row gap-4" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <button disabled={formSubmitLoading || !imageUploadProgress} className="bg-gray-600 text-white p-3 rounded-lg uppercase hover:opacity-85 disabled:opacity-80 hover:scale-105 transition duration-200 animate-pulse">{formSubmitLoading?"Submitting":"Create Listing"}</button>
